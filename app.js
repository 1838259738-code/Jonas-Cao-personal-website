...
const translations = {
  en: {
    ...
    workTitle:'Places where ideas meet<br />the real world.',workIntro:'Companies are coordinates. What matters more is how I understand problems, work with people and move a hazy idea toward something that can be used in very different settings.',
  ...
  de: {
    ...
    workTitle:'Orte, an denen Ideen<br />der Wirklichkeit begegnen.',workIntro:'Unternehmen sind Koordinaten. Wichtiger ist, wie ich in unterschiedlichen Umgebungen Probleme verstehe, mit Menschen zusammenarbeite und aus einer vagen Idee etwas Nutzbares mache.',
